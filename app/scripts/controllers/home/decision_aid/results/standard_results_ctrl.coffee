angular.module('dcida20App')
  .factory 'StandardResultsCtrl', ['$q', '$timeout', '_', 'Util', 'DecisionAidUserOptionProperty', 'DecisionAidUserProperty', ($q, $timeout, _, Util, DecisionAidUserOptionProperty, DecisionAidUserProperty) ->
    class StandardResultsCtrl
        ...
        DecisionAidUserProperty.query {decision_aid_user_id: @decisionAidUser.id}, (userProps) =>
          ...
          DecisionAidUserOptionProperty.query {decision_aid_user_id: @decisionAidUser.id, 'option_ids[]': oids}, (dauops) =>
            ...
            $timeout () =>
              ...
              if @decisionAid.decision_aid_type is "treatment_rankings" and @bestTreatment
      ...
      prevState: () ->
        stateName: "decisionAidProperties"
